...
namespace CSC480_HW1_EightPuzzle
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            root.a1CostAndTilesOutOfPlace = root.TotalTilesOutOfPlace + root.CostOfMovesFromStart;
           ...
           // Stack<StateNode> stack = new Stack<StateNode>();
            ...
            pq.Add(root.a1CostAndTilesOutOfPlace, root);
            SizeOfPQ = SizeOfPQ + 1;
            MaxOfPQ = MaxOfPQ + 1;
            ...
            while (keepRunning)
            {
                ...
                while (qFromSuccessorFunction.Count != 0)
                {
                    ...
                    {
                        pq.Add(removeFromFrontOfSuccessorQueue.a1CostAndTilesOutOfPlace, removeFromFrontOfSuccessorQueue);
